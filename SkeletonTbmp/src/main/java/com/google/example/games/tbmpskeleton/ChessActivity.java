...
import com.google.example.games.tbmpskeleton.gui.Square;
...
public class ChessActivity extends Activity implements View.OnClickListener {
...
//
    ...
    public void updateMatch(TurnBasedMatch match) {
        ...
        switch (turnStatus) {
            case TurnBasedMatch.MATCH_TURN_STATUS_MY_TURN:
                mTurnData = ChessTurn.unpersist(mMatch.getData());
                setGameplayUI();
                return;
    ...
    private InvitationCallback mInvitationCallback = new InvitationCallback() {
        ...
        public void onInvitationRemoved(@NonNull String invitationId) {
            Toast.makeText(ChessActivity.this, "An invitation was removed.", Toast.LENGTH_SHORT)
                    .show();
        }
    };
    ...
    private TurnBasedMatchUpdateCallback mMatchUpdateCallback = new TurnBasedMatchUpdateCallback() {
        ...
        public void onTurnBasedMatchReceived(@NonNull TurnBasedMatch turnBasedMatch) {
            Toast.makeText(ChessActivity.this, "A match was updated.", Toast.LENGTH_LONG).show();
        }

        @Override
        public void onTurnBasedMatchRemoved(@NonNull String matchId) {
            Toast.makeText(ChessActivity.this, "A match was removed.", Toast.LENGTH_SHORT).show();
        }
    };
